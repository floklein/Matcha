...
class Soulmatcher extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        if (nextState.sort !== this.state.sort
            ...
            || nextState.ageMin !== this.state.ageMin
            || nextState.ageMax !== this.state.ageMax
            || nextState.distanceMin !== this.state.distanceMin
            || nextState.distanceMax !== this.state.distanceMax
            || nextState.popularityMin !== this.state.popularityMin
            || nextState.popularityMax !== this.state.popularityMax) {
            return (false)
        } else {
            return (true);
        }
                    ...
                    <div id="soulmatcher">
                        ...
                        <div className="main-panel">
                            ...
                            <div className="cards">
                                ...
                                // .slice(this.state.first, this.state.first + 2)
